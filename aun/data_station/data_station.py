...
from flask_admin import current_user
...
file_dir = os.path.join(
    app.config["BASEDIR"], "aun/static/upload/data_station")
...
class DataStationsApi(Resource):
    ...
    def get(self):
        ...
        files = DataStation.query.filter(DataStation.status=status, DataStation.is_important=is_important).all()
