...
def create_super_role():
    ...
    role.add_node("修改新闻")
    role.add_node("删除新闻")
    role.add_node("添加新闻属性")
    role.add_node("修改新闻属性")
    role.add_node("删除新闻属性")
    role.add_node("添加新闻标签")
    role.add_node("修改新闻标签")
    role.add_node("删除新闻标签")
    role.add_node("修改节点")
    role.add_node("materialAdmin")
    role.add_node("materialAction")
    role.add_node("查看新闻")
    role.add_node("查看新闻栏目")
    role.add_node("查看新闻标签")
    role.add_node("查看用户")
    role.add_node("查看角色")
